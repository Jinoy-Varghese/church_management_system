...
<html>
    ...
    <body>
        ...
        <table>
            <tr><td>
                <div class="head">
        <h1 style="font-size:50px;font-family:algerian;">Marriage Certificate</h1><br>
...
echo "<div class=name style='position:absolute;margin-left:90px;margin-top:-2px;'>".$row['bride']." & ".$row['groom']."</div>";
...
?>
 ...
 <?php 
$v=$_GET['a'];
$sql="SELECT * FROM logs where num='$_GET[a]'";
$result=$conn->query($sql);
$row=$result->fetch_assoc();
